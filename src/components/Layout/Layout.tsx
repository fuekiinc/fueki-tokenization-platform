...
export default function Layout() {
  ...
  return (
    <div className="gradient-bg-subtle relative min-h-screen flex flex-col text-white overflow-x-hidden">
      ...
      <main className="relative z-[1] flex-1 w-full max-w-[1920px] mx-auto px-4 sm:px-8 md:px-12 lg:px-20 xl:px-32 py-8 sm:py-12 md:py-16 lg:py-20 overflow-hidden box-border">
