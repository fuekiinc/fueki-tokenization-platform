...
export const CHAIN_FIXTURES: ChainFixture[] = [
  ...
  { chainId: 80002, name: 'Polygon Amoy', symbol: 'POL', rpcEnv: 'POLYGON_AMOY_RPC_URL', explorer: 'https://amoy.polygonscan.com' },
  { chainId: 43114, name: 'Avalanche', symbol: 'AVAX', rpcEnv: 'AVALANCHE_RPC_URL', explorer: 'https://snowtrace.io' },
  { chainId: 43113, name: 'Avalanche Fuji', symbol: 'AVAX', rpcEnv: 'AVALANCHE_FUJI_RPC_URL', explorer: 'https://testnet.snowtrace.io' },
